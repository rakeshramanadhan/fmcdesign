(function ()
{
    $('document').ready(function ()
    {
         ...
         */
        $('.toggle-source-preview-parent').on('click', function ()
        {
            $(this).parents('.example-parent').toggleClass('show-source');
        });
        /**
         * Flip source-preview child cards
         */
        $('.toggle-source-preview-child').on('click', function ()
        {
            $(this).parents('.example-child').toggleClass('show-source');
        });
    });
     ...
     */
    /*$(window).on('raz::matchMediaChanged', function (ev, currentStep, isOrBelow, isOrAbove)
     {
